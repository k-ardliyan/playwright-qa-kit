...
3. **Demo tokens are kit self-test only** (e.g. `QA-KIT-SAMPLE-PDF`). Product expected content always comes from each requirement’s **Hasil yang Diharapkan** / Input Data — never copy demo tokens into product asserts by default.
