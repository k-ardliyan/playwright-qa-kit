...
| `src/agents/reporter/`          | Pipeline report builder                       | `report-builder.ts`                                            |
...
| `src/pages/`                    | Page Object Models                            | `BasePage.ts` (base class)                                     |
| `src/support/pw/`               | Low-level PW helpers                          | `index.ts` ← always import from here                           |
| `src/support/custom-dashboard/` | HTML report builder                           | `build-*.ts`                                                   |
| `src/support/auth.setup.ts`     | Auth session materialization                  | —                                                              |
| `src/support/auth-paths.ts`     | `authStatePath('<role>')` helper              | —                                                              |
