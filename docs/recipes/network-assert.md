...
await waitAndAssertApi(
  page,
  {
    ...
    // optional: contract: 'test-fixtures/network/contracts/demo/submit-success.json',
  },
  async () => {
...
5. Optional: save partial contract JSON under `test-fixtures/network/contracts/`
...
| Path                                    | Git   | Role                       |
| --------------------------------------- | ----- | -------------------------- |
| `test-fixtures/network/contracts/**`    | Yes   | Partial expected contracts |
| `test-results/**/network-capture*.json` | No    | Runtime attach (redacted)  |
...
- Plans: `.hermes/plans/2026-07-24_network-assert-00-master.md`
