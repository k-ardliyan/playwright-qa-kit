...
export function buildHashRouterJs(): string {
  const lines: string[] = [
    ...
    '        .catch(function(e){ host.innerHTML = "<p class=muted>Failed to load history: " + e.message + "</p>"; host.hidden = false; primary.hidden = true; });',
    '      return;',
    '    }',
    '',
    ...
    '        .catch(function(e){ host.innerHTML = "<p class=muted>Failed to load compare: " + e.message + "</p>"; host.hidden = false; primary.hidden = true; });',
    '      return;',
    '    }',
    '',
    ...
    '        .catch(function(e){ host.innerHTML = "<p class=muted>Failed to load detail: " + e.message + "</p>"; host.hidden = false; primary.hidden = true; });',
    '      return;',
    '    }',
    '',
    '    showPrimary();',
