...
| Server          | Tool                      | Purpose                                                                       |
| --------------- | ------------------------- | ----------------------------------------------------------------------------- |
| `playwright-qa` | `trace_requirement`       | Generate end-to-end TraceabilityContractV1 graph and coverage metrics         |
| `playwright-qa` | `get_test_summary`        | Read pass/fail counts and duration from `artifacts/reports/test-summary.json` |
...
| `playwright-qa` | `archive_report`          | Archive the final pipeline report to `artifacts/reports/archive/<runId>/`     |
